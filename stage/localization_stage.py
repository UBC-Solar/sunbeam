...
class LocalizationStage(Stage):
    ...
    def extract(self,
                gps_latitude_df_loader: FileLoader,
                gps_longitude_df_loader: FileLoader,
                vehicle_velocity_loader: FileLoader) -> tuple[Result, Result, Result]:
        ...
        return gps_latitude_df_result, gps_longitude_df_result, vehicle_velocity_result

    def transform(self, gps_latitude_df_result, gps_longitude_df_result, vehicle_velocity_result) -> tuple[Result, ...]:
        ...
        if not (gps_latitude_df_result and gps_longitude_df_result):
            ...
            track_index_gps_ts = self._get_gps_track_index(gps_latitude_ts, gps_longitude_ts)
    ...
    @staticmethod
    def _get_gps_track_index(lat: TimeSeries, lon: TimeSeries) -> TimeSeries:
